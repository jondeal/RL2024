...
game.current_level.spawn_actor('green slime', game.current_level.get_random_open_tile())
game.current_level.spawn_actor('red slime', game.current_level.get_random_open_tile())
game.current_level.spawn_actor('blue slime', game.current_level.get_random_open_tile())
